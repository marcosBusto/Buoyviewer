...
<span class="hljs-builtin-name">export</span><span class="hljs-built_in"> default </span>{
  ...
  plugins: [ cjs(), resolve({ browser: <span class="hljs-literal">true</span>, preferBuiltins: <span class="hljs-literal">false</span> }) ]
			...
			<table>
				...
				<tbody><tr>
					...
					<tr>
						<td>filter</td>
						<td>object</td>
						<td>A filter to apply to the embedded chart. This expects an object that contains a valid <a href="https://www.mongodb.com/docs/manual/reference/operator/query/#query-selectors">query operators</a>. Any fields referenced in this filter are expected to be added to the allowed list in the &#39;Embed Chart&#39; dialog for each Chart you wish to filter on.</td>
					</tr>
					<tr>
						<td>getUserToken</td>
						<td>function</td>
			...
			<p>Returns the underlying data used to render chart. It has following structure</p>
  ...
  documents: Array&lt;{ [channel]: any }&gt;
			...
			<p>Renders a dashboard into the specified container and should only be invoked once. It returns a Promise that will resolve once the chart is &#39;ready&#39; to accept commands (like <code>refresh</code>).</p>
			...
			<a href="#setautorefreshbool-boolean-promiseltvoidgt-1" id="setautorefreshbool-boolean-promiseltvoidgt-1" style="color: inherit; text-decoration: none;">
				<h4><code>setAutoRefresh(bool: boolean): Promise&lt;void&gt;</code></h4>
			</a>
			...
			<p>Returns the current filter applied to the embedded dashboard chart.</p>
