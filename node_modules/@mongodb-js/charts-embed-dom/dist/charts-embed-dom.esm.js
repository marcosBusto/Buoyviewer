...
class Chart extends CommonChart(Refreshable(EventSource(ChartEventSender))) {
  /**
...
class DashboardChart extends CommonChart(Refreshable(EventSource(DashboardChartEventSender))) {}
